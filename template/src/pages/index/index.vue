...
export default {
    data() {
        return {
            ...
            pagination: {
                page: con.pageIndex, // 当前页数
                limit: con.pageSize, // 每页的展示条数
                total: con.total, // 总数
                alwaysShow: true
            }
        };
    ...
    methods: {
        ...
        handleSearch(data) {
            ...
            this.refreshTable({ page: con.pageIndex, limit: con.pageSize }, true);
        },
        /**
         ...
         */
        refreshTable({ page, limit } = this.pagination, type = false) {
            ...
            api.getTableList(params)
                .then(res => {
                    if (res.Code === code.success) {
                        ...
                        this.pagination.page = res.Data.PageIndex;
                    } else {
                        this.clearTableData();
